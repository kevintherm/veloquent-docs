    ...
    public function getAll(): Collection
    {
        return collect([
            ...
            [
                ...
                'answer' => 'Right now, you can modify the source code directly. In the future, I plan to introduce hooks or an extension system so custom code can be introduced without making change to your project source code directly.',
            ],
            [
